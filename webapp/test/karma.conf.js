...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'src/bower_components/split-pane/split-pane.js',
      'src/bower_components/angular-split-pane/angular-split-pane.js',
      'src/bower_components/angular-bootstrap-nav-tree/dist/abn_tree_directive.js',
